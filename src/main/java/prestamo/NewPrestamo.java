...
public class NewPrestamo {
    ...
    public NewPrestamo(String idCliente, String idPrestamo, double monto, double interesInicial, int numeroCuotas, String tipoPrestamo, boolean tipoCuota, LocalDateTime fechaCreacion, boolean estaPagado) {
    ...
    public static void ShowPrestamos(List<NewPrestamo> Prestamos) {
        String encabezado = String.format(
                "%-3s %-12s %-12s %10s %14s %13s %-15s %-10s %-20s %-10s",
                "ID",
                "ID Cliente",
                "ID Préstamo",
                "Monto",
        ...
        int id = 1;
        for (NewPrestamo Prestamo : Prestamos) {
            System.out.println(String.format(
                    "%-3s %-12s %-12s %10.2f %14.2f %13d %-15s %-10s %-20s %-10s",
                    id,
